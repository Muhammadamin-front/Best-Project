...
test("opens with a guided faith-based welcome and top navigation", async () => {
  ...
  assert.match(welcome, /Odam va Havo alayhimassalom duosi/);
  assert.match(welcome, /Ayyub alayhissalom duosi/);
  assert.match(welcome, /Sulaymon alayhissalom duosi/);
  assert.match(welcome, /Nuh alayhissalom duosi/);
  ...
  assert.equal((welcome.match(/history:/g) || []).length, 8);
