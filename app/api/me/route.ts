...
import { notifications, prayerRequests, prayerSaves, prayerSupports, profiles } from "../../../db/schema";
import { profileUpdateSchema } from "../../../lib/product";
...
export async function PATCH(request: Request) {
  try {
    ...
    if (!parsed.success) {
      return Response.json({ error: "Invalid profile", fields: parsed.error.flatten().fieldErrors }, { status: 400 });
    }
